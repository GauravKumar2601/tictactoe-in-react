...
const TicTacToe = () => {
  ...
  //Using useRef to change the title according to winner
  let titleRef = useRef(null);

  //Making ref of boxes to reset them
  ...
  const reset = () => {
    setLock(false);
    data = ["", "", "", "", "", "", "", "", ""];
    titleRef.current.innerHTML = `Tic Tac Toe Game in <span class="text-cyan-400 ml-3">React</span>`;
